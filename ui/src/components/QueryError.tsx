...
export function QueryError({
  ...
  return (
    <div
      className={`flex items-start gap-3 rounded-lg bg-destructive/8 border border-destructive/20 px-4 py-3 text-sm ${className}`}
    >
...
export function QueryErrorInline({ error }: { error: ApiError | Error | null | undefined }) {
