...
type DeployInput struct {
	...
	// NomadHostNetwork sets host_network on every port block. Accepts "private"
	// or "public". Defaults to "private" when omitted.
	NomadHostNetwork string `json:"nomad_host_network"`
