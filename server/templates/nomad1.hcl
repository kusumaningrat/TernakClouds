...
{{ env_name }}="{% raw %}{{ with secret "secrets/data/{% endraw %}{{ vault_path }}{% raw %}" }}{{ .Data.data.{% endraw %}{{ env_name }}{% raw %} }}{{ end }}{% endraw %}"
{% endfor %}
EOF
      }
      { % endif % }
